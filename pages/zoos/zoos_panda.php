    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header__inner">
                ...
                <h1 class="title_animal">Panda</h1>
...
<div class="online">
    <div class="container">
        ...
        <div class="video">
        <iframe src="https://www.youtube.com/embed/OObOQ2GElhA?autoplay=1;"
    ...
    <div class="container">
        ...
        <div class="accordionsBox">
            ...
            <?php
                ...
                $sql = "SELECT * FROM `accordion` WHERE animal = 'Panda'";
